...
def model_info(model, detailed=False, verbose=True, imgsz=256):
    ...
    #     flops, params = get_model_complexity_info(model, (6,640,640), as_strings=True, print_per_layer_stat=True)
...
def get_flops(model, imgsz=640):
    ...
    try:
        ...
        try:
            ...
            print('Use actual image size for input tensor (i.e. required for RTDETR models)')
