        ...
        with torch.no_grad():
            ...
            if self.track_query_before != None:
                out_dict = self.network.forward(
                    ...
                    search=x_dict, ce_template_mask=self.box_mask_z, track_query_before=self.track_query_before,keep_rate=self.keep_rate )
            else:
                out_dict = self.network.forward(
                    template= self.z_dict ,
                    search=x_dict, ce_template_mask=self.box_mask_z, keep_rate=self.keep_rate )
