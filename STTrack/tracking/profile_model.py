...
def parse_args():
    ...
    # for train
    parser.add_argument('--script', type=str, default='sttrack', choices=['sttrack'],
                        help='training script name')
    parser.add_argument('--config', type=str, default='deep_rgbt_256', help='yaml configure file name')
...
if __name__ == "__main__":
    ...
    if args.script == "sttrack":
        ...
        template = torch.randn(2,bs, 6, z_sz, z_sz)
